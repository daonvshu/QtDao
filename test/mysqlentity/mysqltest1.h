...
public:
    class Fields {
    public:
        dao::EntityField<qint64> id = dao::EntityField<qint64>("id", "ts_mysqltest1");
        dao::EntityField<QString> name = dao::EntityField<QString>("name", "ts_mysqltest1");
        dao::EntityField<qreal> number = dao::EntityField<qreal>("number", "ts_mysqltest1");
        dao::EntityField<QByteArray> hex = dao::EntityField<QByteArray>("hex", "ts_mysqltest1");
