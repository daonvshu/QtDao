...
public:
    class Fields {
    public:
        EntityField<char> fTinyInt = EntityField<char>("f_tiny_int", "ts_mysqltest4");
        EntityField<short> fSmallInt = EntityField<short>("f_small_int", "ts_mysqltest4");
        EntityField<int> fMediumInt = EntityField<int>("f_medium_int", "ts_mysqltest4");
        EntityField<int> fInt = EntityField<int>("f_int", "ts_mysqltest4");
        EntityField<qint64> fBigInt = EntityField<qint64>("f_big_int", "ts_mysqltest4");
        EntityField<double> fFloat = EntityField<double>("f_float", "ts_mysqltest4");
        EntityField<double> fDouble = EntityField<double>("f_double", "ts_mysqltest4");
        EntityField<double> fDecimal = EntityField<double>("f_decimal", "ts_mysqltest4");
        EntityField<QDate> fDate = EntityField<QDate>("f_date", "ts_mysqltest4");
        EntityField<QString> fTime = EntityField<QString>("f_time", "ts_mysqltest4");
        EntityField<QDateTime> fDateTime = EntityField<QDateTime>("f_date_time", "ts_mysqltest4");
        EntityField<QDateTime> fTimestamp = EntityField<QDateTime>("f_timestamp", "ts_mysqltest4");
        EntityField<QChar> fChar = EntityField<QChar>("f_char", "ts_mysqltest4");
        EntityField<QString> fVarChar = EntityField<QString>("f_var_char", "ts_mysqltest4");
        EntityField<QByteArray> fTinyBlob = EntityField<QByteArray>("f_tiny_blob", "ts_mysqltest4");
        EntityField<QString> fTinyText = EntityField<QString>("f_tiny_text", "ts_mysqltest4");
        EntityField<QByteArray> fBlob = EntityField<QByteArray>("f_blob", "ts_mysqltest4");
        EntityField<QString> fText = EntityField<QString>("f_text", "ts_mysqltest4");
        EntityField<QByteArray> fMediumBlob = EntityField<QByteArray>("f_medium_blob", "ts_mysqltest4");
        EntityField<QString> fMediumText = EntityField<QString>("f_medium_text", "ts_mysqltest4");
        EntityField<QByteArray> fLongBlob = EntityField<QByteArray>("f_long_blob", "ts_mysqltest4");
        EntityField<QString> fLongText = EntityField<QString>("f_long_text", "ts_mysqltest4");
    ...
    struct Info {
        ...
        static QString getTableName() {
            return QStringLiteral("ts_mysqltest4");
        }
    ...
    struct Tool {
        static QVariantList getValueWithoutAutoIncrement(const MysqlTest4& entity) {
            return QVariantList()
                << entity.fTinyInt
                << entity.fSmallInt
                << entity.fMediumInt
        ...
        static QVariant getValueByName(const MysqlTest4& entity, const QString& target) {
        ...
        static void bindAutoIncrementId(MysqlTest4& entity, const QVariant& id) {
            Q_UNUSED(entity);
            Q_UNUSED(id);
        }

        static void bindValue(MysqlTest4& entity, const QString& target, QVariant value) {
            if (target == "f_tiny_int") {
        ...
        static MysqlTest4 fromJson(const QJsonObject& object) {
            MysqlTest4 entity;
        ...
        static QJsonObject toJson(const MysqlTest4& entity, QStringList excludeKeys = QStringList()) {
            QJsonObject object;
...
typedef QList<MysqlTest4> MysqlTest4List;
