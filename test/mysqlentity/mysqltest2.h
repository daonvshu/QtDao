...
public:
    class Fields {
    public:
        dao::EntityField<qint64> id = dao::EntityField<qint64>("id", "ts_mysqltest2");
        dao::EntityField<QString> name = dao::EntityField<QString>("name", "ts_mysqltest2");
        dao::EntityField<int> number = dao::EntityField<int>("number", "ts_mysqltest2");
        dao::EntityField<int> number2 = dao::EntityField<int>("number2", "ts_mysqltest2");
