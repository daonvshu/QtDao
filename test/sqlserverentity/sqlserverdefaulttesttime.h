...
class SqlServerDefaultTestTime {
    ...
    Q_PROPERTY(QTime typetime MEMBER typetime)
    Q_PROPERTY(QTime typetime2 MEMBER typetime2)
    Q_PROPERTY(QTime typetime3 MEMBER typetime3)
    Q_PROPERTY(QTime typetime4 MEMBER typetime4)
    ...
    Q_PROPERTY(QByteArray typetimestamp MEMBER typetimestamp)
...
public:
    class Fields {
    public:
        dao::EntityField<QTime> typetime = dao::EntityField<QTime>("typetime", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QTime> typetime2 = dao::EntityField<QTime>("typetime2", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QTime> typetime3 = dao::EntityField<QTime>("typetime3", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QTime> typetime4 = dao::EntityField<QTime>("typetime4", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDate> typedate = dao::EntityField<QDate>("typedate", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDate> typedate2 = dao::EntityField<QDate>("typedate2", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDate> typedate3 = dao::EntityField<QDate>("typedate3", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDate> typedate4 = dao::EntityField<QDate>("typedate4", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDateTime> typedatetime = dao::EntityField<QDateTime>("typedatetime", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDateTime> typedatetime2 = dao::EntityField<QDateTime>("typedatetime2", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDateTime> typedatetime3 = dao::EntityField<QDateTime>("typedatetime3", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QDateTime> typedatetime4 = dao::EntityField<QDateTime>("typedatetime4", "ts_sqlserverdefaulttesttime");
        dao::EntityField<QByteArray> typetimestamp = dao::EntityField<QByteArray>("typetimestamp", "ts_sqlserverdefaulttesttime");

    protected:
        void reset(const QString& tbName) {
            typetime = dao::EntityField<QTime>("typetime", tbName);
            typetime2 = dao::EntityField<QTime>("typetime2", tbName);
            typetime3 = dao::EntityField<QTime>("typetime3", tbName);
            typetime4 = dao::EntityField<QTime>("typetime4", tbName);
            ...
            typetimestamp = dao::EntityField<QByteArray>("typetimestamp", tbName);
        }
    };
