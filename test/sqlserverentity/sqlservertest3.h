...
public:
    class Fields {
    public:
        dao::EntityField<qint64> id = dao::EntityField<qint64>("id", "ts_sqlservertest3");
        dao::EntityField<qint64> tbi1 = dao::EntityField<qint64>("tbi1", "ts_sqlservertest3");
        dao::EntityField<qint64> tbi2 = dao::EntityField<qint64>("tbi2", "ts_sqlservertest3");
        dao::EntityField<QString> name = dao::EntityField<QString>("name", "ts_sqlservertest3");
        dao::EntityField<int> size = dao::EntityField<int>("size", "ts_sqlservertest3");
