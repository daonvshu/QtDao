...
public:
    class Fields {
    public:
        EntityField<QString> typechar = EntityField<QString>("typechar", "ts_sqlserverdefaultteststr");
        EntityField<QString> typechar2 = EntityField<QString>("typechar2", "ts_sqlserverdefaultteststr");
        EntityField<QString> typechar3 = EntityField<QString>("typechar3", "ts_sqlserverdefaultteststr");
        EntityField<QString> typechar4 = EntityField<QString>("typechar4", "ts_sqlserverdefaultteststr");
        EntityField<QString> typechar5 = EntityField<QString>("typechar5", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarchar = EntityField<QString>("typevarchar", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarchar2 = EntityField<QString>("typevarchar2", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarchar3 = EntityField<QString>("typevarchar3", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarchar4 = EntityField<QString>("typevarchar4", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarchar5 = EntityField<QString>("typevarchar5", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarcharmax = EntityField<QString>("typevarcharmax", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarcharmax2 = EntityField<QString>("typevarcharmax2", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarcharmax3 = EntityField<QString>("typevarcharmax3", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarcharmax4 = EntityField<QString>("typevarcharmax4", "ts_sqlserverdefaultteststr");
        EntityField<QString> typevarcharmax5 = EntityField<QString>("typevarcharmax5", "ts_sqlserverdefaultteststr");
        EntityField<QString> typetext = EntityField<QString>("typetext", "ts_sqlserverdefaultteststr");
        EntityField<QString> typetext2 = EntityField<QString>("typetext2", "ts_sqlserverdefaultteststr");
        EntityField<QString> typetext3 = EntityField<QString>("typetext3", "ts_sqlserverdefaultteststr");
        EntityField<QString> typetext4 = EntityField<QString>("typetext4", "ts_sqlserverdefaultteststr");
        EntityField<QString> typetext5 = EntityField<QString>("typetext5", "ts_sqlserverdefaultteststr");

    protected:
        void reset(const QString& tbName) {
            typechar = EntityField<QString>("typechar", tbName);
            typechar2 = EntityField<QString>("typechar2", tbName);
            typechar3 = EntityField<QString>("typechar3", tbName);
            typechar4 = EntityField<QString>("typechar4", tbName);
            typechar5 = EntityField<QString>("typechar5", tbName);
            ...
            typevarcharmax = EntityField<QString>("typevarcharmax", tbName);
            typevarcharmax2 = EntityField<QString>("typevarcharmax2", tbName);
            typevarcharmax3 = EntityField<QString>("typevarcharmax3", tbName);
            typevarcharmax4 = EntityField<QString>("typevarcharmax4", tbName);
            typevarcharmax5 = EntityField<QString>("typevarcharmax5", tbName);
